...
#dt_al = DecisionTreeRegressor(random_state=42)
...
accuracy_al_rf_f = accuracy_al_rf

accuracy_mae_al_rf_f = accuracy_mae_al_rf
    
accuracy_mse_al_rf_f = accuracy_mse_al_rf
...
accuracy_al_dt_f = accuracy_al_dt/n_cv

accuracy_mae_al_dt_f = accuracy_mae_al_dt/n_cv
    
accuracy_mse_al_dt_f = accuracy_mse_al_dt/n_cv
...
accuracy_al_ls_f = accuracy_al_ls/n_cv

accuracy_mae_al_ls_f = accuracy_mae_al_ls/n_cv
    
accuracy_mse_al_ls_f = accuracy_mse_al_ls/n_cv
